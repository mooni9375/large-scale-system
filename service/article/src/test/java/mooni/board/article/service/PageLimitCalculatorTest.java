...
class PageLimitCalculatorTest {
    ...
    void calculatePageLimitTest(Long page, Long pageSize, Long movableCount, Long expected) {
        Long result = PageLimitCalculator.calculatePageLimit(page, pageSize, movableCount);
