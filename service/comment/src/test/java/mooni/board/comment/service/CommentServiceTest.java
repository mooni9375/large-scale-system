...
@ExtendWith(MockitoExtension.class) // Mockito 활용 가능토록
class CommentServiceTest {

    @InjectMocks
    CommentService commentService; // 실제 테스트 대상
    @Mock
    CommentRepository commentRepository; // Mock(가짜 객체) 객체로 주입 (실제 DB 접근 X)
